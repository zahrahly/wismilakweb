    ...
    public function scan(Request $request)
{
    ...
    return view('admin.checkin.scan', compact('recentCheckins', 'eventId'));
}
    public function process(Request $request)
    {
        ...
        try {
            ...
            /**
             * =====================================================
             * FORMAT 2: QR BERISI TICKET NUMBER SAJA
             * contoh:
             * TCK-ABC123456
             * =====================================================
             */
...
'user' => $ticket->full_name ?? $ticket->user->name,
            ...
            Log::error('Checkin process failed', [
                'error' => $e->getMessage()
            ]);
