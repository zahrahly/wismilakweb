    ...
    <a href="{{ route('partner.events.index') }}" class="nav-link {{ request()->routeIs('partner.events.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('partner.checkin.scan') }}" class="nav-link {{ request()->routeIs('partner.checkin.*') ? 'active' : '' }}">
