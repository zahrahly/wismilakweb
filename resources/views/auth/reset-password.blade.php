...
<div class="left-panel">
  ...
  <div class="left-content">
    ...
    <p class="brand-desc">
      Your journey continues. Set a new password and return to the excellence of Wismilak Premium Cigars.
    </p>
  </div>
</div>
...
<div class="right-panel">
  <div class="form-container">
    <div class="form-header">
      <p class="form-tag">Security Update</p>
      <h2 class="form-title">Reset</h2>
      <p class="form-subtitle">Define your new access credentials</p>
    </div>
