...
<style>
    .stat-card-premium {
        position: relative;
        overflow: hidden;
        padding: 1.5rem 2rem; /* FIXED: Added padding to prevent text from being too close to the line */
...
<div class="animate-in" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2.5rem;">
    <div>
        <h1 style="font-family: 'Crimson Pro', serif; font-size: 3rem; font-weight: 700; color: var(--text-primary); margin-bottom: 0.5rem; letter-spacing: -0.03em;">Feedback Analytics</h1>
        <p style="color: var(--text-secondary); font-size: 1.1rem; max-width: 600px; line-height: 1.6;">A comprehensive overview of attendee satisfaction and event quality across the Wismilak Experience ecosystem.</p>
    </div>
</div>
...
<div style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 2rem; margin-bottom: 2.5rem;">
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
        <div class="stat-card-premium animate-in" style="animation-delay: 0.1s;">
            ...
            <div class="trend" style="color: var(--gold); font-weight: 600;">Verified</div>
            <div class="icon-bg">
        ...
        <div class="stat-card-premium animate-in" style="animation-delay: 0.2s; border-left: 3px solid var(--gold);">
            <div>
                ...
                <div class="value" style="color: var(--gold);">{{ number_format($stats['avg_rating'], 1) }}</div>
            </div>
        ...
        <div class="stat-card-premium animate-in" style="animation-delay: 0.3s; border-left: 3px solid var(--green);">
            <div>
                <div class="label">Perfect Scores</div>
                <div class="value" style="color: var(--green);">{{ number_format($stats['five_star']) }}</div>
            </div>
            <div class="trend" style="color: var(--green);">{{ round(($stats['five_star'] / max($stats['total'], 1)) * 100) }}% Success</div>
            <div class="icon-bg">
        ...
        <div class="stat-card-premium animate-in" style="animation-delay: 0.4s; border-left: 3px solid var(--red);">
            <div>
                ...
                <div class="value" style="color: var(--red);">{{ number_format($stats['one_star']) }}</div>
            </div>
            <div class="trend" style="color: var(--red);">Action Required</div>
            <div class="icon-bg">
...
<div class="premium-card animate-in" style="animation-delay: 0.6s; margin-bottom: 2.5rem; background: rgba(255,255,255,0.01); border-color: rgba(255,255,255,0.08);">
    <div style="padding: 1.75rem 2rem;">
        <form method="GET" action="{{ route('admin.feedback.index') }}" style="display: grid; grid-template-columns: 2fr 1.5fr 1.5fr auto; gap: 1.5rem; align-items: end;">
            ...
            <div style="display: flex; gap: 0.75rem;">
                ...
                <a href="{{ route('admin.feedback.index') }}" class="btn-premium" style="background: rgba(255,255,255,0.05); color: var(--text-primary) !important; padding: 0.75rem 1.5rem; border-radius: 12px;">RESET</a>
            </div>
        </form>
    </div>
</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="text-align: right; padding-right: 2rem; width: 100px;">Actions</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="table-row-premium">
                ...
                <td style="text-align: right; padding-right: 2rem;">
                    <a href="{{ route('admin.feedback.show', $feedback) }}" class="btn-premium" style="background: rgba(212, 175, 55, 0.1); color: var(--gold) !important; border: 1px solid var(--gold-dim); padding: 0.5rem 1rem; font-size: 0.7rem; border-radius: 8px;">
                        REVIEW
                    </a>
                </td>
            </tr>
