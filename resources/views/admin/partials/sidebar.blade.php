    ...
    <a href="{{ route('admin.event.index') }}" class="nav-link {{ request()->routeIs('admin.event.index') || request()->routeIs('admin.event.create') || request()->routeIs('admin.event.edit') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.event.verification') }}" class="nav-link {{ request()->routeIs('admin.event.verification') || request()->routeIs('admin.event.detail') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.event.participants') }}" class="nav-link {{ request()->routeIs('admin.event.participants*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        Peserta Event
    </a>
    <a href="{{ route('admin.checkin.scan') }}" class="nav-link {{ request()->routeIs('admin.checkin.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.pressroom.index') }}" class="nav-link {{ request()->routeIs('admin.pressroom.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.outlets.index') }}" class="nav-link {{ request()->routeIs('admin.outlets.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.chat-topics.index') }}" class="nav-link {{ request()->routeIs('admin.chat-topics.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/></svg>
        Topik Chat
    </a>
    <a href="{{ route('admin.feedback.index') }}" class="nav-link {{ request()->routeIs('admin.feedback.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
        Feedback
    </a>
    <a href="{{ route('admin.media.inquiries') }}" class="nav-link {{ request()->routeIs('admin.media.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.points.users') }}" class="nav-link {{ request()->routeIs('admin.points.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.vouchers.index') }}" class="nav-link {{ request()->routeIs('admin.vouchers.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/></svg>
        Voucher & Reward
    </a>
    ...
    <form method="POST" action="{{ route('logout') }}" class="mobile-only-nav" style="display: none; width: 100%;">
        @csrf
        <button type="submit" class="nav-link" style="color: #E74C4C; border: none; background: none; width: calc(100% - 1rem); text-align: left; cursor: pointer; display: flex; align-items: center; gap: 0.75rem;">
